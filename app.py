...
if menu == "Deskripsi":
    ...
    st.title("KLASIFIKASI RESIKO PENYAKIT JANTUNG MENGGUNAKAN METODE SUPPORT VECTOR MACHINE (SVM) DENGAN SELEKSI FITUR INFORMATION GAIN")
    ...
    with col2:
        st.image(
            "sesudah_smote.png",
            caption="Sesudah SMOTE",
            width=400
        )
    st.subheader("Perbandingan Jumlah Fitur Pada Seleksi Fitur Information Gain")
    # buat 2 kolom
    col1, col2 = st.columns(2)
    ...
    with col1:
        st.image(
            "diagram perbandingan akurasi.png",
            caption="Diagram Perbandingan Jumlah Fitur",
            width=400
        )   
    ...
    with col2:
        st.image(
            ...
            caption="Grafik Perbandingan Jumlah Fitur",
            width=400
        )
    st.subheader("Rangking 13 Fitur Terbaik")
    st.image(
        "diagram_informationgain.png",
        caption="Ranking 13 Fitur Terbaik Information Gain",
        width=700
    )
